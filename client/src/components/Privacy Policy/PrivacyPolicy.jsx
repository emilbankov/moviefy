                        ...
                        <div className="col-md-12">
                            <div className="mb-4">
                                ...
                                <p>
                                    ...
                                    detailed as possible. Try to visualize and then plan for,{" "}
                                </p>
                                <p>
                                    ...
                                    step takes you closer to your Vision and Goals. If the plan
                                    doesn’t support the vision then change it!
                                </p>
                            </div>
                            <div className="mb-4">
                                ...
                                <ul className="list list-unstyled mb-3">
                                    <li>
                                        <i className="fas fa-check" /> The truth about success
                                    </li>
                                    <li>
                                        <i className="fas fa-check" /> If success is a process with a
                                        number of defined steps,
                                    </li>
                                    <li>
                                        <i className="fas fa-check" /> Then it is just like any other
                                        process.
                                    </li>
                                    <li>
                                        <i className="fas fa-check" /> The first action is always in
                                        making the decision to proceed.{" "}
                                    </li>
                                    <li>
                                        <i className="fas fa-check" /> This is a fundamental step, which
                                        most people overlook.
                                    </li>
                                </ul>
                                <p>
                                    We also know those epic stories, those modern-day legends
                                    surrounding the early failures of such supremely successful folks
                                    as Michael Jordan and Bill Gates. We can look a bit further back
                                    in time to Albert Einstein or even further back to Abraham
                                    Lincoln. What made each of these people so successful? Motivation.
                                </p>
                            </div>
                            <div className="mb-4">
                                ...
                                <p>
                                    ...
                                    it’s not reserved only for a select few people. As such, success
                                    really has nothing to do with luck, coincidence or fate. It really
                                    comes down to understanding the steps in the process and then
                            ...
                            <div>
                                ...
                                <ul className="list list-unstyled mb-3">
                                    <li>
                                        <i className="fas fa-check" /> You are going on a cruise, but
                                        when the ship sets sail,
                                    </li>
                                    <li>
                                        <i className="fas fa-check" /> The sad thing is the majority of
                                        people have no clue about what they truly want.{" "}
                                    </li>
                                    <li>
                                        <i className="fas fa-check" /> Once you have a clear
                                        understanding of what you want,
                                    </li>
                                    <li>
                                        <i className="fas fa-check" /> Focus is having the unwavering
                                        attention to complete what you set out to do.
                                    </li>
                                </ul>
                                <p className="mb-0">
